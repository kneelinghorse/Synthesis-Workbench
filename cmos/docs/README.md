...
1. [Project Agents](../../agents.md) - App-level instructions for this repo
2. [Getting Started](./getting-started.md) - Quick setup guide
3. [Build Session Prompt](./build-session-prompt.md) - Template for build sessions
4. [Session Management Guide](./session-management-guide.md) - Planning, reviews, research
